...
### Fixed
- Fixed invalid MkDocs icon (drum → music-circle)

## [1.5.1] - 2025-12-15

### Changed
- Redesigned GitHub Pages landing page with hero section and feature cards
- Added dark/light mode toggle
- Moved documentation to dedicated nav section
